          ...
          if guess not in letters_guessed:
              ...
              if guess in secret_word:
                  ...
                  if guess in vowels:
                      ...
                      num_guesses -= 1
                      print("Oops! That letter is not in my word and you lose a chance to guess", guessed_word)
          else:
              if num_warnings > 0:
                  num_warnings -= 1
                  print("Oops! You've already guessed that letter. You have", num_warnings, " warnings left", guessed_word)
              else:
                  num_guesses -= 1
                  print("Oops! You've already guessed that letter. You now have no warnings and you lose one guess", guessed_word)
      else:
          if num_warnings > 0:
              num_warnings -= 1
              print("Oops!That is not a valid letter. You have", num_warnings, "warnings left", guessed_word)
          else:
              num_guesses -= 1
              print("Oops! That is not a valid letter. You have", num_guesses, "guesses left", guessed_word)
